...
let centimeters1 = Math.floor(centimeters % 100);
var div = document.getElementById("output6");
div.innerHTML = `Kilometers: ${kilometers}<br/>Meters: ${meters}<br/>Centimeters: ${centimeters1}`
  /////////////////////////////// DO NOT MODIFY
...
let quart = Math.floor((fluidOunces / 32) % 4);
let pint = Math.floor((fluidOunces / 16) % 2);
let cup = Math.floor((fluidOunces / 8) % 2);
let fluidOunces1 = Math.floor(fluidOunces % 8);
var div = document.getElementById("output7");
div.innerHTML = `Gallons: ${gallons}<br/>Quarts: ${quart}<br/>Pints: ${pint}<br/>Cups: ${cup}<br/>Fluid Ounces: ${fluidOunces1}`
  /////////////////////////////// DO NOT MODIFY
...
let pounds = Math.floor((ounces / 16) % 2000);
let ounces1 = Math.floor(ounces % 16 );
var div = document.getElementById("output8");
div.innerHTML = `Tons: ${tons}<br/>Pounds: ${pounds}<br/>Ounces: ${ounces1}`
